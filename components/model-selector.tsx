...
import {CheckCircleFillIcon, ChevronDownIcon} from './common/icons';
...
export function ModelSelector({
    ...
    // Safely resolve userType with a fallback
    const availableChatModels = chatModels;

    // Ensure we always show a valid selection even if cookie points to a model the user can't use
